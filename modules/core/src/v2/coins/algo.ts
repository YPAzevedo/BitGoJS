...
export class Algo extends BaseCoin {
  ...
  private explainWalletInitializationException(txJson: TxData) {
  ...
  private static getCompatibleTxType(tx: TxData) {
    ...
    switch (rawType) {
      case 'enableToken':
        // backward compatible
        return TransactionType[TransactionType.EnableAsset];
      case 'disableToken':
        // backward compatible
        return TransactionType[TransactionType.DisableAsset];
      case 'transferToken':
        // backward compatible
